...
func TestAddFlagsMoreThanOnce(t *testing.T) {
	var foo, bar int
	cli, err := clim.New[any]("banana", "I am tasty", nil)
...
func TestActionPresent(t *testing.T) {
	cli, err := clim.New[string]("basket", "juicy fruits",
...
func TestParseOneFlagPairSuccess(t *testing.T) {
	var count int
	cli, err := clim.New[any]("basket", "juicy fruits", nil)
	rosina.AssertNoError(t, err)
	rosina.AssertNoError(t, err)
...
func TestSubCommandNamesMustBeUnique(t *testing.T) {
	...
	subCliB, err := clim.New[any]("sub", "I am a subcommand B", nil)
	rosina.AssertNoError(t, err)
...
func TestAddGroupSuccess(t *testing.T) {
	child, err := clim.New[any]("child", "I am a child", nil)
	rosina.AssertNoError(t, err)

	root, err := clim.New[any]("bang", "bang head", nil)
	rosina.AssertNoError(t, err)

	err = root.AddCLI(child)
	rosina.AssertNoError(t, err)
